...
function hilbertDemo() {
    ...
    function d3Digest() {
        ...
        svg.select('path:not(.skeleton)')
            .transition().duration(order * 10000).ease(d3.easeLinear)
...
window.onload = hilbertDemo;
// // Adapted from https://codepen.io/hakimel/pen/KanIi
...
// var RADIUS_SCALE = 3;
// var RADIUS_SCALE_MIN = 2.5;
// var RADIUS_SCALE_MAX = 4;
...
//     }
//     else {
//         RADIUS_SCALE -= ( RADIUS_SCALE - RADIUS_SCALE_MIN ) * (0.2);
//     }
